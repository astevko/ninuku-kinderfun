 ...
 */
public class LocationAddPhotoHeader extends HeaderPanel {
	 ...
	 * TODO: move to constants
	 */
	private static final String	PLAYGROUND_TITLE	= "Add Playground";

	/**
	 * every class has its own logger
	 */
	static private final Logger			logger	= Logger.getLogger(LocationAddPhotoHeader.class.getName());
	 ...
	 */
	@Inject
	public LocationAddPhotoHeader(final ClientFactory clientFactory) {
		// back button
